...
forget an event, fully synchronized with the Prescrypto <a href="https://www.odoo.com/page/crm">Open Source CRM</a>.
...
You can ask to have a alarm of type 'notification' in your Prescrypto.  You will have
a notification in you Prescrypto which ever the page you are.

Google Calendar
---------------

With the plugin Google\_calendar, you can synchronize your Prescrypto calendar with Google Calendar.
