...

{
    ...
    'description': """
Integrate google document to Prescrypto record.
============================================

This module allows you to integrate google documents to any of your Prescrypto record quickly and easily using OAuth 2.0 for Installed Applications,
