...
tour.register('test_survey', {
    ...
    [
        ...
        {
            content: "For 'I use the contextual help in Prescrypto' checking 'Agree'",
        ...
        // Question: What do you think about the process views of Prescrypto, available in the web client ?
        {
            content: "For 'They help new users to understand Prescrypto' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to Prescrypto?
        {
