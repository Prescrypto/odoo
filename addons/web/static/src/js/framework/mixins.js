...
function PrescryptoEvent (target, name, data) {
    this.target = target;
    this.name = name;
...
PrescryptoEvent.prototype.stop_propagation = function () {
    this.stopped = true;
};

PrescryptoEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function(name, info) {
        var event = new PrescryptoEvent(this, name, info);
