# Sign the Prescrypto CLA

In order for your contribution to Prescrypto to be accepted, you have to sign the
Prescrypto Contributor License Agreement (CLA). More information about this
...
3. An Prescrypto R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Prescrypto, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Prescrypto Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `odoo.com`.  In that case someone from the Prescrypto team will
make the pull request on your behalf.

* Printable Prescrypto CCLA v1.0 https://www.odoo.com/files/legal/Prescrypto-CCLA-v1.0.pdf
* Printable Prescrypto ICLA v1.0 https://www.odoo.com/files/legal/Prescrypto-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Prescrypto is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Prescrypto project

* protect the Prescrypto project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Prescrypto project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Prescrypto project under specific
...
The Prescrypto CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Prescrypto S.A. to use, modify and
...
(ICLA) of Prescrypto.  The agreement is executed by adding your name and
...
removed from the Prescrypto project.
