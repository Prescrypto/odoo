...
Prescrypto is greatly data-driven, and a big part of modules definition is thus
...
The main way to define data in Prescrypto is via XML data files: The broad structure
...
Because some important structural models of Prescrypto are complex and involved,
