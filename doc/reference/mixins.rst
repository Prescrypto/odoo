...
Prescrypto implements some useful classes and mixins that make it easy for you to add
...
database without needing to connect to Prescrypto directly.
...
catchall domain will be sufficient since all routing will be done inside Prescrypto.
...
* ``helpdesk.ticket`` in the Helpdesk (*helpdesk* - Prescrypto Enterprise only) Application
