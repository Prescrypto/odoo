...
QWeb is the primary templating_ engine used by Prescrypto\ [#othertemplates]_. It
...
.. py:method:: render(cr, uid, id[, values][, engine='ir.qweb][, context])
    ...
    :param str engine: name of the Prescrypto model to use for rendering, can be
...
.. [#othertemplates] although it uses a few others, either for historical
                     ...
                     use case. Prescrypto 9.0 still depends on Jinja_ and Mako_.
