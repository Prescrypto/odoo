...
Prescrypto provides support for testing modules using unittest.
...
`unittest documentation`_, but Prescrypto provides a number of utilities and helpers
related to testing Prescrypto content (modules, mainly):
...
As of Prescrypto 8, running tests outside of the install/update cycle is not
supported.
