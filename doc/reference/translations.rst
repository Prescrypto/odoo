...
automatically loaded by Prescrypto when the corresponding language is installed (via
...
Prescrypto automatically exports translatable strings from "data"-type content:
...
code, Prescrypto cannot automatically export translatable terms so they
