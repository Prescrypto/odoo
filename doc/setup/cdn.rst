...
In the Prescrypto back end, go to the :guilabel:`Website Settings`: menu, then
...
resulting problem on a default Prescrypto website will be the lack of font-awesome
